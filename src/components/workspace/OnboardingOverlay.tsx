...
const steps = [
  {
    target: "sidebar",
    title: "Add an agent",
    desc: 'Click the "+" button to add a Perspective agent and start generating renders.',
  },
  {
    target: "chat",
    title: "Chat with your agent",
    desc: "Describe your design direction. The agent will generate options for you.",
  },
  {
    target: "gallery",
    title: "Review & refine",
    desc: "Keep what you like, refine or delete what you don't.",
  },
];
...
const OnboardingOverlay = ({ projectId }: Props) => {
  ...
  const positions: Record<string, string> = {
    sidebar: "left-[280px] top-1/3",
    chat: "right-[340px] top-1/3",
